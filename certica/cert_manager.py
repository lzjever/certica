...
class CertManager:
    ...
    def sign_certificate(
        ...
        with tempfile.NamedTemporaryFile(mode='w', suffix='.cnf', delete=False) as f:
            ...
            self._write_cert_config(
                f, cert_type, common_name, dns_names, ip_addresses,
                organization, country, state, city
            )
    ...
    def _write_cert_config(
        self, f, cert_type: str, common_name: str,
        dns_names: List[str], ip_addresses: List[str],
        organization: str, country: str, state: str, city: str
    ):
